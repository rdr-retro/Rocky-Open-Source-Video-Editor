...
/**
 * Generator for a solid Black color.
 */
public class BlackGenerator implements RockyMediaGenerator {
    @Override
    public String getName() { return "Negro"; }
    @Override
    public String getDescription() { return "Genera un plano de color negro."; }
    @Override
    ...
    public List<PluginParameter> getParameters() {
        ...
        params.add(new PluginParameter("Rojo", PluginParameter.Type.SLIDER, 0.0));
        params.add(new PluginParameter("Verde", PluginParameter.Type.SLIDER, 0.0));
    ...
    public void generate(Graphics2D g2, int width, int height, long frame, Map<String, Object> params) {
        float r = ((Number)params.getOrDefault("Rojo", 0.0)).floatValue();
        float g = ((Number)params.getOrDefault("Verde", 0.0)).floatValue();
