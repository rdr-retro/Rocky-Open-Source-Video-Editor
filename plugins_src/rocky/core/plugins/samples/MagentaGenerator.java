...
/**
 * Generator for a solid Magenta color.
 */
public class MagentaGenerator implements RockyMediaGenerator {
    @Override
    public String getName() { return "Magenta"; }
    @Override
    public String getDescription() { return "Genera un plano de color magenta."; }
    @Override
