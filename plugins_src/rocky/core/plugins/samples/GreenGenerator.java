...
/**
 * Generator for a solid Green color.
 */
public class GreenGenerator implements RockyMediaGenerator {
    @Override
    public String getName() { return "Verde"; }
    @Override
    public String getDescription() { return "Genera un plano de color verde."; }
    @Override
