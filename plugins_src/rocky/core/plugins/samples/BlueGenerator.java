...
/**
 * Generator for a solid Blue color.
 */
public class BlueGenerator implements RockyMediaGenerator {
    @Override
    public String getName() { return "Azul"; }
    @Override
    public String getDescription() { return "Genera un plano de color azul."; }
    @Override
