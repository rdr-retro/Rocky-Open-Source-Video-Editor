...
/**
 * Generator for a solid Red color.
 */
public class RedGenerator implements RockyMediaGenerator {
    @Override
    public String getName() { return "Rojo"; }
    @Override
    public String getDescription() { return "Genera un plano de color rojo."; }
    @Override
