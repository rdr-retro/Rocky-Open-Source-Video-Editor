...
/**
 * Generator for a solid Cyan color.
 */
public class CyanGenerator implements RockyMediaGenerator {
    @Override
    public String getName() { return "Cian"; }
    @Override
    public String getDescription() { return "Genera un plano de color cian."; }
    @Override
