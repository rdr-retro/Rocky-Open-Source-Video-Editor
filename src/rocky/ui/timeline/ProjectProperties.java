...
public class ProjectProperties {
    private List<AppliedPlugin> videoBusEffects = new ArrayList<>();
    ...
    public void setPluginsEnabled(boolean b) {
        this.pluginsEnabled = b;
    }
    ...
    public List<AppliedPlugin> getVideoBusEffects() {
        return videoBusEffects;
    }
