...
public class SettingsDialog extends JDialog {
    ...
    private JComboBox<String> templateCombo, fieldOrderCombo, pixelAspectCombo, fpsCombo;
    private JComboBox<String> pixelFormatCombo, gammaCombo, qualityCombo, blurTypeCombo, deinterlaceCombo,
            resampleCombo, acesCombo;
    ...
    public SettingsDialog(Frame parent, ProjectProperties props) {
        ...
        tabs.addTab("Proxy", createProxyTab(props));
    ...
    private JPanel createVideoTab(ProjectProperties props) {
        ...
        gbc.gridy = 1;
        gbc.gridx = 0;
        p.add(createLabel("Anchura:"), gbc);
        gbc.gridx = 1;
        widthField = createStyledField(String.valueOf(props.getProjectWidth()));
        p.add(widthField, gbc);
        gbc.gridx = 2;
        p.add(createLabel("Orden de campos:"), gbc);
        gbc.gridx = 3;
        fieldOrderCombo = createStyledCombo(new String[] { "Ninguno (escaneo progresivo)", "Campo superior primero" },
                props.getFieldOrder());
        p.add(fieldOrderCombo, gbc);

        gbc.gridy = 2;
        gbc.gridx = 0;
        p.add(createLabel("Altura:"), gbc);
        gbc.gridx = 1;
        heightField = createStyledField(String.valueOf(props.getProjectHeight()));
        p.add(heightField, gbc);
        gbc.gridx = 2;
        p.add(createLabel("Relación de aspecto del píxel:"), gbc);
        gbc.gridx = 3;
        pixelAspectCombo = createStyledCombo(new String[] { "1,0000 (Cuadrado)", "1,2121 (NTSC Widescreen)" },
                props.getPixelAspectRatio());
        p.add(pixelAspectCombo, gbc);

        gbc.gridy = 3;
        gbc.gridx = 2;
        p.add(createLabel("Inicio de salida:"), gbc);
        gbc.gridx = 3;
        p.add(createLabel("0 grados (original)"), gbc); // Static for now

        gbc.gridy = 4;
        gbc.gridx = 0;
        out360Check = new JCheckBox("Salida 360");
        ...
        gbc.gridx = 2;
        p.add(createLabel("Velocidad de fotogramas:"), gbc);
        gbc.gridx = 3;
        fpsCombo = createStyledCombo(new String[] { "23,976 (película IVTC)", "24,000", "29,970", "30,000", "60,000" },
                String.valueOf(props.getFPS()));
        p.add(fpsCombo, gbc);
        ...
        gbc.gridy = 6;
        gbc.gridx = 0;
        p.add(createLabel("Formato de píxel:"), gbc);
        gbc.gridx = 2;
        pixelFormatCombo = createStyledCombo(new String[] { "8 bits", "32 bits (punto flotante)" },
                props.getPixelFormat());
        p.add(pixelFormatCombo, gbc);

        gbc.gridy = 7;
        gbc.gridx = 0;
        p.add(createLabel("Gamma de composición:"), gbc);
        gbc.gridx = 2;
        ...
        gbc.gridy = 8;
        gbc.gridx = 0;
        p.add(createLabel("Versión ACES:"), gbc);
        gbc.gridx = 2;
        p.add(createLabel("1.0"), gbc);

        gbc.gridy = 9;
        gbc.gridx = 0;
        p.add(createLabel("Espacio de color:"), gbc);
        gbc.gridx = 2;
        ...
        gbc.gridy = 10;
        gbc.gridx = 0;
        p.add(createLabel("Transformación de la vista:"), gbc);
        gbc.gridx = 2;
        p.add(createLabel("Desactivado"), gbc);

        gbc.gridy = 11;
        gbc.gridx = 0;
        p.add(createLabel("Calidad de renderización de máx. resolución:"), gbc);
        gbc.gridx = 2;
        ...
        gbc.gridy = 12;
        gbc.gridx = 0;
        p.add(createLabel("Tipo de desenfoque de movimiento:"), gbc);
        gbc.gridx = 2;
        ...
        gbc.gridy = 13;
        gbc.gridx = 0;
        p.add(createLabel("Método de eliminación de entrelazado:"), gbc);
        gbc.gridx = 2;
        deinterlaceCombo = createStyledCombo(new String[] { "Ninguno", "Fusionar campos" },
                props.getDeinterlaceMethod());
        p.add(deinterlaceCombo, gbc);

        gbc.gridy = 14;
        gbc.gridx = 0;
        p.add(createLabel("Modo Re-muestreo:"), gbc);
        gbc.gridx = 2;
        resampleCombo = createStyledCombo(new String[] { "Re-muestreo inteligente", "Forzar re-muestreo" },
                props.getResampleMode());
        p.add(resampleCombo, gbc);

        gbc.gridy = 15;
        gbc.gridx = 0;
        gbc.gridwidth = 4;
        adjustSourceCheck = new JCheckBox(
                "Ajustar medios de origen para que coincidan con la configuración de proyecto o renderización");
        ...
        gbc.gridwidth = 1;
        gbc.gridx = 0;
        p.add(createLabel("Carpeta de archivos renderizados previamente:"), gbc);
        gbc.gridx = 1;
        gbc.gridwidth = 2;
        renderFolderField = createStyledField("/tmp/rocky_renders");
        p.add(renderFolderField, gbc);
        gbc.gridx = 3;
        gbc.gridwidth = 1;
        p.add(createStyledButton("Examinar...", false), gbc);
        ...
        gbc.gridy = 18;
        startDefaultCheck = new JCheckBox("Iniciar todos los nuevos proyectos con esta configuración");
    ...
    private JPanel createAudioTab(ProjectProperties props) {
        ...
        p.add(createStyledCombo(new String[] { "44100", "48000", "96000" },
                String.valueOf(props.getAudioSampleRate())));
        return p;
    }

    private JPanel createProxyTab(ProjectProperties props) {
        JPanel p = new JPanel(new GridBagLayout());
        p.setOpaque(false);
        p.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        GridBagConstraints gbc = new GridBagConstraints();
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        p.add(createLabel("Resolución Proxy (Altura):"), gbc);
        gbc.gridx = 1;
        proxyResCombo = createStyledCombo(new String[] { "360", "480", "720" }, String.valueOf(props.getProxyHeight()));
        p.add(proxyResCombo, gbc);

        gbc.gridx = 0;
        gbc.gridy = 1;
        p.add(createLabel("Bitrate (Calidad):"), gbc);
        gbc.gridx = 1;
        proxyBitrateCombo = createStyledCombo(new String[] { "500k", "1000k", "2000k" }, props.getProxyBitrate());
        ...
        JLabel hint = createLabel(
                "<html><i>Menor resolución/bitrate = Generación más rápida.<br>Mayor resolución = Mejor calidad de vista previa.</i></html>");
        p.add(hint, gbc);
    ...
    private JPanel createVisorTab(ProjectProperties props) {
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        p.add(createLabel("Resolución de Vista Previa (Escala):"), gbc);
        gbc.gridx = 1;

        String[] scales = { "Completa (Full)", "Media (1/2)", "Cuarto (1/4)", "Octavo (1/8)" };
        String currentScale = "Media (1/2)";
        if (props.getVisorScale() == 1.0)
            currentScale = "Completa (Full)";
        else if (props.getVisorScale() == 0.5)
            currentScale = "Media (1/2)";
        else if (props.getVisorScale() == 0.25)
            currentScale = "Cuarto (1/4)";
        else if (props.getVisorScale() == 0.125)
            currentScale = "Octavo (1/8)";

        visorScaleCombo = createStyledCombo(scales, currentScale);
        p.add(visorScaleCombo, gbc);

        gbc.gridx = 0;
        gbc.gridy = 1;
        p.add(createLabel("Calidad de Bitrate (Interpolación):"), gbc);
        gbc.gridx = 1;
        visorBitrateCombo = createStyledCombo(new String[] { "Alta", "Media", "Baja" }, props.getVisorBitrate());
        ...
        gbc.gridwidth = 2;
        JLabel hint = createLabel(
                "<html><i>Reducir la resolución de vista previa mejora drásticamente<br>el rendimiento de reproducción en tiempo real.</i></html>");
        p.add(hint, gbc);
    ...
    private JTextField createStyledField(String text) {
        ...
        f.setBorder(BorderFactory.createLineBorder(ACCENT_COLOR, 1));
        return f;
    }
    ...
    private JComboBox<String> createStyledCombo(String[] items, String selected) {
        ...
        cb.setUI(new javax.swing.plaf.basic.BasicComboBoxUI() {
            ...
            protected JButton createArrowButton() {
                ...
                b.setBackground(ACCENT_COLOR); // Use accent color for arrow button
                b.setForeground(Color.WHITE);
                b.setFocusPainted(false);
                b.setContentAreaFilled(false); // Flat look
                b.setOpaque(true);
                return b;
            }
        });
        ...
        // Custom Renderer for the drop-down list items
    ...
    public void applyTo(ProjectProperties props) {
        ...
        props.setProxyHeight(Integer.parseInt((String) proxyResCombo.getSelectedItem()));
        props.setProxyBitrate((String) proxyBitrateCombo.getSelectedItem());

        String vScale = (String) visorScaleCombo.getSelectedItem();
        if (vScale.contains("Completa"))
            props.setVisorScale(1.0);
        else if (vScale.contains("Media"))
            props.setVisorScale(0.5);
        else if (vScale.contains("Cuarto"))
            props.setVisorScale(0.25);
        else if (vScale.contains("Octavo"))
            props.setVisorScale(0.125);

        props.setVisorBitrate((String) visorBitrateCombo.getSelectedItem());
    }
}
