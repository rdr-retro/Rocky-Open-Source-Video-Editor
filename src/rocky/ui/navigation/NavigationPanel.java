...
public class NavigationPanel extends JPanel {
    ...
    // Region: Constants
    private static final Color BG_COLOR = Color.decode("#0f051d");
    private static final Color TAB_BAR_BG = Color.decode("#1a0b2e");
    private static final Color ACCENT_LILAC = Color.decode("#dcd0ff");
    private static final Color TEXT_GRAY = new Color(150, 140, 180);
    // End Region: Constants

    // Region: Fields
    private final CardLayout cardLayout;
    private final JPanel contentPanel;
    private final NavigationTabBar tabBar;
    ...
    public void setProjectProperties(ProjectProperties props, Runnable onUpdate) {
