            ...
            try {
                ...
                Thread loggerThread = new Thread(() -> {
                    try (java.io.BufferedReader r = new java.io.BufferedReader(new java.io.InputStreamReader(p.getInputStream()))) {
                        ...
                        while ((L = r.readLine()) != null) {
                            ...
                            if (L.contains("Error")) System.err.println("[FFmpeg] " + L);
                        }
                    } catch (Exception e) {}
                });
                loggerThread.start();
                ...
                for (long f = 0; f < totalFrames; f++) {
                    ...
                    try {
                        ...
                        if (f % 30 == 0) os.flush(); // Flush less often
                ...
                if (listener != null) {
                    ...
                    else listener.onError("FFmpeg error (code " + exitCode + "). Log:\n" + ffmpegOutput.toString());
                }
                ...
                if (listener != null) {
                    ...
                    if (msg == null || msg.isEmpty()) msg = "Error desconocido durante el renderizado.";
