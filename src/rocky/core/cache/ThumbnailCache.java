...
public class ThumbnailCache {
     ...
     */
    public BufferedImage getThumbnail(String mediaPath, long frameNumber, double projectFPS, Runnable callback) {
        ...
        generatorExecutor.submit(() -> {
            ...
            try {
                ...
                if (thumb == null) {
                    thumb = generateThumbnail(mediaPath, frameNumber, projectFPS);
                    if (thumb != null) {
    ...
    private BufferedImage generateThumbnail(String path, long frameNumber, double projectFPS) {
        ...
        try {
            ...
            // Set Timestamp
            long timestamp = (long) ((frameNumber / projectFPS) * 1_000_000L);
