...
class RockyPanel(QFrame):
    ...
    def __init__(self, content_widget, title="Editor", parent=None):
        ...
        # FIX: Removed setMask to prevent layout imbalances and clipping during playback
        # Rounded corners are now purely visual or handled by CSS background truncation
        # if possible, but for now we prioritize visibility.
        self.viewport.resizeEvent = lambda e: None 
        ...
        if self.current_type == "Tools" and content_widget:
            ...
            if content_widget:
                ...
                content_layout.addWidget(content_widget, stretch=1)
    ...
    def _create_panel_content(cls, panel_type):
        ...
        if panel_type == "Viewer":
            ...
            try:
                from ..timeline.simple_timeline import SimpleTimeline
                from ..core.models import TimelineModel
            ...
            try:
                from ..panels.python_terminal import PythonTerminalPanel
            ...
            try:
                from ..panels.subtitle_panel import SubtitlePanel
