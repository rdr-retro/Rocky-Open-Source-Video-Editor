...
import os
from .styles import PUSH_BUTTON_STYLE, TOOLBAR_STYLE, UI_FONT
...
class RockyToolbar(QFrame):
    def __init__(self, parent=None):
        ...
        self.btn_logo.setStyleSheet("QPushButton { background: transparent; border: none; padding: 2px; } QPushButton:hover { background: rgba(255,255,255,15); border-radius: 4px; }")
