from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QSlider, QFrame, QGraphicsDropShadowEffect
...
class AudioEnhancerPanel(QFrame):
    ...
    """
    effect_applied = pyqtSignal(str, float) # effect_name, intensity
