from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QTabWidget, QLabel, QFrame, QPushButton, QInputDialog, QLayout, QSizePolicy, QScrollArea, QDialog, QSpinBox, QComboBox, QCheckBox
