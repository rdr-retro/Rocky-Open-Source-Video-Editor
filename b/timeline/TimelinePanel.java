...
public class TimelinePanel extends JPanel {
    ...
    public void setMediaPool(egine.media.MediaPool pool) {
        this.mediaPool = pool;
    }
    ...
    private void drawFadeCurve(Graphics2D g2d, TimelineClip.FadeType type, boolean isFadeIn, int startX, int width,
            int topY, int height) {
        if (width <= 0)
            return;
