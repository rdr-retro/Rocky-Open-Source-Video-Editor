...
public class SidebarPanel extends JPanel {
    ...
    // Actually looking at the image: Top Left box with numbers is NOT the same color as the ruler. It looks like a dark grey/black box.
    // Ruler is lighter.
    ...
    public void addTrack(TrackControlPanel.TrackType type, int index) {
        ...
        track.setResizeListener(() -> {
            ...
            if (onAddTrack != null) onAddTrack.run(); 
        });
    ...
    private void reorderTracks(int fromIndex, int toIndex) {
        ...
        if (onReorderTracks != null) onReorderTracks.onReorder(fromIndex, toIndex);
        if (onAddTrack != null) onAddTrack.run();
    }
